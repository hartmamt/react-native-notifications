...
public class RNNotificationsModule extends ReactContextBaseJavaModule
        implements AppLifecycleFacade.AppVisibilityListener, Application.ActivityLifecycleCallbacks {
    ...
    public void postLocalNotification(ReadableMap propsMap, int notificationId) {
        ...
        final NotificationProps localNotificationProps = NotificationProps.fromBundle(context,
                Arguments.toBundle(propsMap));
    ...
    public void cancelLocalNotification(int notificationId, @Nullable String notificationTag) {
        INotificationDrawer notificationsDrawer = NotificationDrawer
                .get(getReactApplicationContext().getApplicationContext());
    ...
    public void cancelAllLocalNotifications() {
        INotificationDrawer notificationDrawer = NotificationDrawer
                .get(getReactApplicationContext().getApplicationContext());
